...
export function SocialProofSection({
  projects,
  label = getSectionDefaultLabel("socialProof"),
    ...
    >
      <div className="mx-auto flex max-w-[1920px] flex-col items-center gap-12 md:gap-20">
        <header className="flex w-full flex-col gap-6 px-6 md:flex-row md:items-start md:justify-between md:px-20">
          <div className="flex max-w-[533px] flex-col gap-6">
            <SectionBracketLabel
              sectionKey="socialProof"
              label={label}
              tone="black"
            />
            <h2 className="font-arc-sans text-arc-heading leading-[1.2] text-black">
              {title}
            </h2>
          </div>
